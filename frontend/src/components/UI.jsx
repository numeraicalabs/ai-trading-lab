/**
 * Shared design system — import { C, Card, Badge, ... } from './components/UI'
 * Keeping everything in one file makes the design system easy to update.
 */
...
export function Spinner() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: 80 }}>
      <div className="spin" style={{ width: 24, height: 24, borderRadius: '50%',
